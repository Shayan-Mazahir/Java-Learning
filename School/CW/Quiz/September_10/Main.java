package School.CW.Quiz.September_10;
...
public class Main {
    public static void main(String[] args) {
        ...
        if (x <= 1) {
            ...
            int i = 2;
            //every number after the square root of the number is the same patteren being repeated (try your self for 30; any number after 6 and 6 would be repeating)
