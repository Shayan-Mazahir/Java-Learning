...
public class Transformers {
    ...
    // Inner class representing Autobots, which inherits from Transformers
    public class Autobots extends Transformers {
        // Constructor for Autobots, matching the superclass constructor
        public Autobots(String name, String color, int weapons, boolean mask, int age) {
            super(name, color, weapons, mask, age); // Call to the superclass constructor
        }
    }
}
